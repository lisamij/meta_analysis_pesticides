This project contains file for the analysis of Mercer et al 202X. It is structured as follows: 

- analyses: R files that allow to run the main analyses
- data: Input data that were extracted from the literature 
